...
export default {
  ...
  setup() {
    ...
    // const getForums = computed(() => store.state.forums);
    // const getPosts = computed(() => store.state.posts);

    // onMounted(async () => {
    //   await store.dispatch("getCategories");
    //   await store.dispatch("getForums");
    //   await store.dispatch("getPosts");

    //   data.categories = getCategories.value;
    //   data.forums = getForums.value;
    //   data.posts = getPosts.value;

    //   console.log("categories", data.categories);
    //   console.log("forums", data.forums[0]);
